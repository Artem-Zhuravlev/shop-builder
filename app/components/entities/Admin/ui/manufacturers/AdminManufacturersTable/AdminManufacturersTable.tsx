...
export const AdminManufacturersTable: FC<AdminManufacturersTableProps> = (
	props,
) => {
	const { nodes } = props;
	const data = { nodes };
						...
						{tableList.map((item) => (
							<Row item={item} key={item.id}>
								...
								<Cell>
									<ButtonBase
										onClick={() =>
											router.push(`${ADMIN_ROUTES.manufacturers}/${item.slug}`)
										}
									>
...
AdminManufacturersTable.displayName = 'AdminManufacturersTable';
